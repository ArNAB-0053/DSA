class Solution:
    ...
    # Note: One Code optimization can be make - that is instead of 4 helpers, only use 2, one for minimums and another for maximums, overall complexity will be same, but just be a code optimization.
